...
You will need to copy the `cosmic_paint` subdirectory to your Pico's root filesystem. You can copy a directory in Thonny by right clicking on it in the Files window, and selecting 'Upload to Pico'.
...
Run `cosmic_paint.py` through Thonny and it should get connected and give you a URL to visit. Open that URL in your browser and start painting!